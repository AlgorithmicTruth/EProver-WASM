...
/* Emscripten stubs: no signal or rlimit support */
void ESignalSetup(int mysignal)    { (void)mysignal; }
void ESignalHandler(int mysignal)  { (void)mysignal; }
void ESigTermSchedHandler(int mysignal) { (void)mysignal; }
#else
