...
/* Stub implementations for Emscripten -- networking not supported */
static int create_server_sock_nofail(int port) { (void)port; return -1; }
static int create_client_sock_nofail(char* host, int port) { (void)host;(void)port; return -1; }
int CreateServerSock(int port) { (void)port; Error("Networking not supported in WASM", OTHER_ERROR); return -1; }
void Listen(int sock) { (void)sock; }
int CreateClientSock(char* host, int port) { (void)host;(void)port; Error("Networking not supported in WASM", OTHER_ERROR); return -1; }
MsgStatus TCPMsgWrite(int sock, TCPMsg_p msg) { (void)sock;(void)msg; return NWError; }
MsgStatus TCPMsgRead(int sock, TCPMsg_p msg) { (void)sock;(void)msg; return NWError; }
MsgStatus TCPMsgSend(int sock, TCPMsg_p msg) { (void)sock;(void)msg; return NWError; }
TCPMsg_p  TCPMsgRecv(int sock, MsgStatus *res) { (void)sock; *res=NWError; return TCPMsgAlloc(); }
MsgStatus TCPStringSend(int sock, char* str, bool err) { (void)sock;(void)str;(void)err; return NWError; }
char*     TCPStringRecv(int sock, MsgStatus* res, bool err) { (void)sock;(void)err; *res=NWError; return NULL; }
void      TCPStringSendX(int sock, char* str) { (void)sock;(void)str; }
char*     TCPStringRecvX(int sock) { (void)sock; return NULL; }
#else /* !__EMSCRIPTEN__ */
